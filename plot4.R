...
make_plot4 <- function(quiet = FALSE){
        #the data url
        ...
        #setting the two-by-two plot lattice
        par(mfrow=c(2,2))
        ...
        legend("topright", lty = "solid", bty = "n", col = c("black", "blue", "red"), legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"))
